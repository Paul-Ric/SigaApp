...
import Financeiro from './componentesTelas/financeiro'
import CotacaoResp from './componentesTelas/cotacaoResp'
import PecasVendidas from './componentesTelas/pecasVendidas'
...
import Cotacao1 from './componentesTelas/abrircotacao'
import GaleriaFt from './componentesTelas/galeriaFotos'
  ...
  return(
    ...
    <NavigationContainer>
      ...
      screenOptions={{headerShown:false}}>
        ...
        <Stack.Screen name ='Cotacao1' component={Cotacao1}/>
        <Stack.Screen name = 'GaleriaFt' component={GaleriaFt}/>
